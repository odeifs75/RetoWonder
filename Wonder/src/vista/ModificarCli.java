 ...
 * @author alvaro
 */
public class ModificarCli extends JDialog implements ActionListener {
	 ...
	 * @param rela 
	 */
	public ModificarCli(Dao dao, Relacion rela, Usuario usu) {
		this.usu=usu;
		this.rela = rela;
		this.dao = dao;
		...
		comboOrientacion.setModel(new DefaultComboBoxModel(
				new String[] {"Heterosexual", "Homosexual"}));
	...
	private void btncancelar() {
		...
		VCliente vcli = new VCliente(dao, null);
